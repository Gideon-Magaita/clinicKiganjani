# Generated by Django 4.1.7 on 2024-05-28 08:36
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('hospital_name', models.CharField(default='Mhimbili', max_length=200)),
                ('childs_name', models.CharField(default='child', max_length=200)),
                ('vaccine_date', models.DateField()),
                ('return_date', models.DateField()),
                ('comment', models.TextField()),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('vaccine_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.vaccine')),
            ],
        ),
        migrations.CreateModel(
            name='Health',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('elimu_ya_mama', models.CharField(choices=[('none', 'none'), ('secondary', 'secondary'), ('primary', 'primary'), ('university', 'university')], max_length=200)),
                ('kazi_ya_mama', models.CharField(max_length=200)),
                ('urefu_wa_mama', models.DecimalField(decimal_places=1, max_digits=10)),
                ...
                ('elimu_ya_mume', models.CharField(choices=[('none', 'none'), ('secondary', 'secondary'), ('primary', 'primary'), ('university', 'university')], max_length=200)),
                ('urefu_wa_mume', models.DecimalField(decimal_places=1, max_digits=10)),
